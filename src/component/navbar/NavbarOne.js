                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav tocenter">
                            ...
                            <li className="nav-item right">
                                <Button component={Link} to="/signup" id='signupbut' variant="outlined">Sign up</Button>
                            </li>
                            <li className="nav-item right">
                                <Button component={Link} to="/signin" id='signinbut' variant="contained">Sign in</Button>
                            </li>
                        </ul>
                    </div>
                </div>
